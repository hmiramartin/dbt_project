  ...
  create or replace view `dazzling-tiger-361615`.`project`.`mart_stackoverflow_quarterly`
  OPTIONS()
  as 
...
with quarterly as (
    select
        a.uni_pk,
        timestamp_trunc(a.creation_date_datetime_utc, quarter) as first_day_of_period,
